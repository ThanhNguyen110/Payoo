...
class GetBankCode extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $website_url = $this->_scopeConfig->getValue('payment/payoo/website_url', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        ...
        $url = 'https://newsandbox.payoo.com.vn/v2/api/paynow/get-banks-partner?code=Ecommerce&url=' . $website_url . '&id=' . $shop_id . '&seller=' . $business_username . '&jsonCallback=0';
        $response = $this->getResponseValue($url);
